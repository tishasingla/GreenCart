...
const Cart = () => {
  ...
  try {
    ...
    if (paymentOption === "COD") {
      ...
      return; // 🧼 so razorpay logic doesn’t run
    }
    ...
    console.log("Razorpay Init Response 🧾:", data);
      ...
      handler: async function (response) {
        try {
          ...
          const verifyRes = await axios.post('/api/order/verify', {
            ...
            orderId // Needed for update on backend DB
          });
    ...
    toast.error(error.message || "Something went wrong placing the order.");
  }
};
